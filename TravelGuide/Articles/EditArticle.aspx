<%@ Page Title="Edit Article" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditArticle.aspx.cs" Inherits="TravelGuide.Articles.EditArticle" %>

<asp:Content ID="EditArticle" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">
        <div class="card card-add-article">
            ...
            <div class="card-content">
                ...
                <div class="row text-center">
                    <asp:Button Text="Submit" CssClass="btn btn-success btn-login" ID="BtnEditArticleSubmit" OnClick="BtnEditArticleSubmit_Click" runat="server" />
                </div>
            </div>
        </div>
    </div>
