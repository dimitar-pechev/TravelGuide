    ...
    <div class="container gallery-container">
        <div class="row">
            <div class="row text-right button-row">
                <asp:HyperLink NavigateUrl="~/Gallery/AddPhoto.aspx" ID="NewPhotoLink" Visible="false" CssClass="btn btn-success" Text="Add new photo" runat="server" />
            </div>
                    ...
                    <div class="col-md-4">
                        <asp:HyperLink NavigateUrl='<%#: string.Format("~/Gallery/Details.aspx?id={0}", Item.Id) %>' runat="server">
                            <div class="card gallery-item" runat="server">
                                <div class="card-content gallery-view"> 
