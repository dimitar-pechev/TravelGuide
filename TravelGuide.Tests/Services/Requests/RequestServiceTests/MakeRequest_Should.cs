...
namespace TravelGuide.Tests.Services.Requests.RequestServiceTests
{
    ...
    public class MakeRequest_Should
    {
        ...
        public void CallFactoryMethod_WhenParamsAreValid()
        {
            ...
            factoryMock.Setup(x=> x.CreateRequest(It.IsAny<Guid>(), It.IsAny<StoreItem>(), It.IsAny<Guid>(), It.IsAny<User>(), It.IsAny<string>(),
            ...
            // Assert
            factoryMock.Verify(x => x.CreateRequest(It.IsAny<Guid>(), It.IsAny<StoreItem>(), It.IsAny<Guid>(), It.IsAny<User>(), It.IsAny<string>(),
