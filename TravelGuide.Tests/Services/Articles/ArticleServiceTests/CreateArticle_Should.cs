...
namespace TravelGuide.Tests.Services.Articles.ArticleServiceTests
{
    ...
    public class CreateArticle_Should
    {
        ...
        public void ThrowArgumentNullException_WhenPassedUsernameIsNull(string id)
        {
            ...
            // Act & Assert
            var ex = Assert.Throws<ArgumentNullException>(() => service.CreateArticle(id, title, city, country, contentMain, contentMustSee,
                contnentBudget, contentAccomodation, imageUrl, secondImage, thirdImage, coverImage));
        }
        ...
        public void ThrowInvalidOperationException_WhenNoSuchUserIsFound()
        {
            ...
            // Act & Assert
            var ex = Assert.Throws<InvalidOperationException>(() => service.CreateArticle(id, title, city, country, contentMain, contentMustSee,
                contnentBudget, contentAccomodation, imageUrl, secondImage, thirdImage, coverImage));
        }
        ...
        public void CallSaveChanges_WhenInputDataIsValid()
        {
            ...
            // Act
            service.CreateArticle(id, title, city, country, contentMain, contentMustSee,
                contnentBudget, contentAccomodation, imageUrl, secondImage, thirdImage, coverImage);
