...
namespace TravelGuide.Tests.Services.Articles.ArticleServiceTests
{
    ...
    public class EditArticle_Should
    {
        ...
        public void ThrowInvalidOperationException_WhenNoSuchArticleIsFound()
        {
            ...
            // Act & Assert
            Assert.Throws<InvalidOperationException>(() => service.EditArticle(id, title, city, country, contentMain, contentMustSee, contnentBudget, contentAccomodation,
                imageUrl, secondImage, thirdImage, coverImage));
        }
        ...
        public void CorrectlyAssignNewTitleValue_WhenInputParamsAreValid()
        {
            ...
            // Act
            service.EditArticle(id, title, city, country, contentMain, contentMustSee, contnentBudget, contentAccomodation,
                imageUrl, secondImage, thirdImage, coverImage);
