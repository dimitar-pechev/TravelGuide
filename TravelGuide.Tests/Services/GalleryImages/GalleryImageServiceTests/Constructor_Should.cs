...
using TravelGuide.Tests.Services.GalleryImages.Mocks;
...
namespace TravelGuide.Tests.Services.GalleryImages.GalleryImageServiceTests
{
    ...
    public class Constructor_Should
    {
        ...
        public void ThrowArgumentNullException_WhenPassedContextIsNull()
        {
            ...
            // Act & Assert
            var ex = Assert.Throws<ArgumentNullException>(() => new GalleryImageService(null, imageFactoryMock.Object,
                 likeFactoryMock.Object, commentFactoryMock.Object));
        ...
        public void ThrowArgumentNullException_WhenPassedImgFactoryIsNull()
        {
            ...
            // Act & Assert
            var ex = Assert.Throws<ArgumentNullException>(() => new GalleryImageService(contextMock.Object, null,
                 likeFactoryMock.Object, commentFactoryMock.Object));
        ...
        public void ThrowArgumentNullException_WhenPassedLikeFactoryIsNull()
        {
            ...
            // Act & Assert
            var ex = Assert.Throws<ArgumentNullException>(() => new GalleryImageService(contextMock.Object, imageFactoryMock.Object,
                 null, commentFactoryMock.Object));
        ...
        public void CorrectlyAssignContext_WhenPassedParamsAreValid()
        {
            ...
            // Act
            var service = new ExtendedGalleryImageService(contextMock.Object, imageFactoryMock.Object, likeFactoryMock.Object, commentFactoryMock.Object);
