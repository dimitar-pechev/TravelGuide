...
namespace TravelGuide.Models.Articles
{
    public class Article : IArticle
    {
        ...
        public Article(User user, Guid userId, string title, string city, 
            string country, string contentMain, string contentMustSee, string contentBudgetTips, string contentAccomodation,
